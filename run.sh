...
CUDA_VISIBLE_DEVICES=0 torchrun --nnodes 1 --nproc_per_node 1 --master_port 29000 run_qudra.py --run_mode train
CUDA_VISIBLE_DEVICES=0 torchrun --nnodes 1 --nproc_per_node 1 --master_port 29000 run_qudra.py --run_mode eval
# python3 test_singlepy